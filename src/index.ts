...
const genesisBlock: Block = new Block(0, "2ajdaj299", "", "hello", 123456)
...
const createNewBlock = (data: string): Block => {
    ...
    const newHash: string = Block.calculateBlockHash(newIndex, previousBlock.hash, getNewTimeStamp(), data);
